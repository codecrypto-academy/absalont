...
export const ESCROW_ABI = [
  ...
  'function getOperation(uint256 _operationId) external view returns (tuple(address initiator, address recipient, uint256 amountA, uint256 amountB, address tokenA, address tokenB, uint8 status, uint256 createdAt))',
