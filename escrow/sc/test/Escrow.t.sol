...
contract EscrowTest is Test {
    ...
    function testAddToken() public {
        ...
        escrow.addToken(address(newToken)); // Owner puede añadir
    ...
    function testCannotRemoveTokenNotAllowed() public {
        MockERC20 unallowedToken = new MockERC20("Token X", "TKNX");
        vm.expectRevert("Token not allowed");
        escrow.removeToken(address(unallowedToken));
    }
    ...
    function testCannotCreateWithUnallowedTokenB() public {
        MockERC20 unallowedToken = new MockERC20("Token X", "TKNX");
        vm.prank(user1);
    ...
    function testGetAllOperations() public {
        ...
        assertEq(allOps[0].amountA, 10e18);
        assertEq(allOps[1].amountA, 20e18);
    }
    ...
    function testMockERC20Metadata() public {
        ...
        vm.prank(user1);
        tokenA.burn(10e18);
        assertEq(tokenA.balanceOf(user1), balanceBefore - 10e18);
    }

    function testMultipleOperations() public {
        vm.prank(user1);
        uint256 op1 = escrow.createOperation(
            100e18,
            user2,
            100e18,
            address(tokenA),
        ...
        vm.prank(user1);
        uint256 op2 = escrow.createOperation(
            50e18,
            user2,
            50e18,
            address(tokenA),
